...
// Walking away keeps the Lock: it is only spent when a currency is actually APPLIED
// (committed). Under one Lock you can foresee any number of currencies, and raise
// quality (infuser / whetstone / scrap) to re-seed the outcomes, until you commit one.
